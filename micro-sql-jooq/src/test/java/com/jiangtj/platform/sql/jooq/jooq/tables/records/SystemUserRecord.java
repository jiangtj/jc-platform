...
public class SystemUserRecord extends UpdatableRecordImpl<SystemUserRecord> implements Record4<Long, String, String, Byte> {
    ...
    /**
     * Setter for <code>system-db.system_user.id</code>.
     */
    ...
    /**
     * Getter for <code>system-db.system_user.id</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>system-db.system_user.username</code>.
     */
    ...
    /**
     * Setter for <code>system-db.system_user.password</code>.
     */
    ...
    /**
     * Setter for <code>system-db.system_user.is_deleted</code>.
     */
    ...
    /**
     * Getter for <code>system-db.system_user.is_deleted</code>.
     */
     ...
     * Create a detached, initialised SystemUserRecord
     */
    public SystemUserRecord(com.jiangtj.platform.sql.jooq.jooq.tables.pojos.SystemUser value) {
        super(SystemUser.SYSTEM_USER);
