...
public class SystemOperateRecordRecord extends UpdatableRecordImpl<SystemOperateRecordRecord> implements Record4<Long, LocalDateTime, Long, String> {
    ...
    /**
     * Setter for <code>system-db.system_operate_record.id</code>.
     */
    ...
    /**
     * Getter for <code>system-db.system_operate_record.id</code>.
     */
    public Long getId() {
        return (Long) get(0);
    }
    ...
    /**
     * Setter for <code>system-db.system_operate_record.create_time</code>.
     */
    ...
    /**
     * Setter for <code>system-db.system_operate_record.operator</code>.
     */
    ...
    /**
     * Setter for <code>system-db.system_operate_record.content</code>.
     */
     ...
     * Create a detached, initialised SystemOperateRecordRecord
     */
    public SystemOperateRecordRecord(com.jiangtj.platform.sql.jooq.jooq.tables.pojos.SystemOperateRecord value) {
        super(SystemOperateRecord.SYSTEM_OPERATE_RECORD);
