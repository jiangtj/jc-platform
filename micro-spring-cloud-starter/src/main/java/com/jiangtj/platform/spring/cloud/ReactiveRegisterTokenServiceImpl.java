...
@Slf4j
public class ReactiveRegisterTokenServiceImpl extends InstanceDiscoveryListener implements RegisterTokenService {

    private boolean isR = false;
    private final ReactiveCoreInstanceApi coreInstanceApi;
    @Resource
    private DiscoveryClient discoveryClient;
    @Resource
    private ApplicationProperty applicationProperty;

    public ReactiveRegisterTokenServiceImpl(ReactiveCoreInstanceApi coreInstanceApi) {
