...
public class DatabasechangelogRecord extends TableRecordImpl<DatabasechangelogRecord> implements Record14<String, String, String, LocalDateTime, Integer, String, String, String, String, String, String, String, String, String> {
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.ID</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.ID</code>.
     */
    @NotNull
    @Size(max = 255)
    public String getId() {
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.AUTHOR</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.AUTHOR</code>.
     */
    @NotNull
    @Size(max = 255)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.FILENAME</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.FILENAME</code>.
     */
    @NotNull
    @Size(max = 255)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.DATEEXECUTED</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.DATEEXECUTED</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.ORDEREXECUTED</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.ORDEREXECUTED</code>.
     */
    @NotNull
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.EXECTYPE</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.EXECTYPE</code>.
     */
    @NotNull
    @Size(max = 10)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.MD5SUM</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.MD5SUM</code>.
     */
    @Size(max = 35)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.DESCRIPTION</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.DESCRIPTION</code>.
     */
    @Size(max = 255)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.COMMENTS</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.COMMENTS</code>.
     */
    @Size(max = 255)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.TAG</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.TAG</code>.
     */
    @Size(max = 255)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.LIQUIBASE</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.LIQUIBASE</code>.
     */
    @Size(max = 20)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.CONTEXTS</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.CONTEXTS</code>.
     */
    @Size(max = 255)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.LABELS</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.LABELS</code>.
     */
    @Size(max = 255)
    ...
    /**
     * Setter for <code>jc_admin.DATABASECHANGELOG.DEPLOYMENT_ID</code>.
     */
    ...
    /**
     * Getter for <code>jc_admin.DATABASECHANGELOG.DEPLOYMENT_ID</code>.
     */
    @Size(max = 10)
     ...
     * Create a detached, initialised DatabasechangelogRecord
     */
    public DatabasechangelogRecord(com.jiangtj.platform.system.jooq.tables.pojos.Databasechangelog value) {
        super(Databasechangelog.DATABASECHANGELOG);
