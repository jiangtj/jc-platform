...
public class SystemKeyShareRecord extends UpdatableRecordImpl<SystemKeyShareRecord> implements Record4<String, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public SystemKeyShareRecord values(String value1, String value2, LocalDateTime value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SystemKeyShareRecord(String kid, String jwk, LocalDateTime publishTime, LocalDateTime readTime) {
        super(SystemKeyShare.SYSTEM_KEY_SHARE);
